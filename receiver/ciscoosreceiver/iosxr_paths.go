...
var iosXRPathCatalog = []iosXRPathDefinition{
	...
	{ID: "interfaces.counters", Group: "interfaces", Path: "Cisco-IOS-XR-infra-statsd-oper:infra-statistics/interfaces/interface/generic-counters", Description: "Native interface counters", MinSampleInterval: time.Minute, HighVolume: true},
	{ID: "interfaces.rates", Group: "interfaces", Path: "Cisco-IOS-XR-infra-statsd-oper:infra-statistics/interfaces/interface/data-rate", Description: "Native interface data rates", MinSampleInterval: time.Minute, HighVolume: true},
	...
	{ID: "fib.srv6loc", Group: "fib", Path: "Cisco-IOS-XR-fib-common-oper:cef-accounting/vrfs/vrf/afis/afi/pfx/srv6locs/srv6loc", Description: "SRv6 local SID accounting", MinSampleInterval: time.Minute, HighVolume: true},
	...
	{ID: "bgp.flowspec", Group: "bgp", Path: "Cisco-IOS-XR-flowspec-oper:flow-spec/vrfs/vrf/afs/af/flows/flow", Description: "BGP FlowSpec flow statistics", MinSampleInterval: time.Minute, HighVolume: true},
	...
	{ID: "security_policy.flowspec", Group: "security_policy", Path: "Cisco-IOS-XR-flowspec-oper:flow-spec/summary", Description: "FlowSpec summary", MinSampleInterval: time.Minute},

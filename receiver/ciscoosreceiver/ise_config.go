...
func defaultISEGroupConfig(enabled bool, maxResults int) ISEGroupConfig {
...
func defaultISEConfig() ISEConfig {
	return ISEConfig{
		...
		MaxResults:      1000,
		Deployment:      defaultISEGroupConfig(true, 1000),
		NetworkDevices:  defaultISEGroupConfig(true, 5000),
		Endpoints:       defaultISEGroupConfig(true, 5000),
		Sessions:        defaultISEGroupConfig(true, 5000),
		AuthFailures:    defaultISEGroupConfig(true, 5000),
		Accounting:      defaultISEGroupConfig(true, 5000),
		Policy:          defaultISEGroupConfig(true, 5000),
		Posture:         defaultISEGroupConfig(true, 5000),
		Profiler:        defaultISEGroupConfig(true, 5000),
		TrustSec:        defaultISEGroupConfig(true, 5000),
		Alarms:          defaultISEGroupConfig(true, 1000),
		Certificates:    defaultISEGroupConfig(true, 1000),
		Licensing:       defaultISEGroupConfig(true, 1000),
		Webhooks:        defaultISEGroupConfig(true, 1000),
		...
		DataConnect: ISEDataConnectConfig{
			...
			Views: map[string]ISEGroupConfig{
				"NODE_LIST":                           defaultISEGroupConfig(true, 1000),
				"NETWORK_DEVICES":                     defaultISEGroupConfig(true, 5000),
				"NETWORK_DEVICE_GROUPS":               defaultISEGroupConfig(true, 5000),
				"POLICY_SETS":                         defaultISEGroupConfig(true, 5000),
				"OPENAPI_OPERATIONS":                  defaultISEGroupConfig(true, 5000),
				"ADMINISTRATOR_LOGINS":                defaultISEGroupConfig(true, 5000),
				"ADMIN_USERS":                         defaultISEGroupConfig(true, 5000),
				"RADIUS_AUTHENTICATIONS_WEEK":         defaultISEGroupConfig(true, 5000),
				"RADIUS_ACCOUNTING_WEEK":              defaultISEGroupConfig(true, 5000),
				"TACACS_AUTHENTICATION_LAST_TWO_DAYS": defaultISEGroupConfig(true, 5000),
				"TACACS_AUTHORIZATION_LAST_TWO_DAYS":  defaultISEGroupConfig(true, 5000),
				"TACACS_ACCOUNTING_LAST_TWO_DAYS":     defaultISEGroupConfig(true, 5000),
				"TACACS_COMMAND_ACCOUNTING":           defaultISEGroupConfig(true, 5000),
				"POSTURE_ASSESSMENT_BY_ENDPOINT":      defaultISEGroupConfig(true, 5000),
				"PROFILED_ENDPOINTS_SUMMARY":          defaultISEGroupConfig(true, 5000),
				"PROFILING_POLICIES":                  defaultISEGroupConfig(true, 5000),
				"ADAPTIVE_NETWORK_CONTROL":            defaultISEGroupConfig(true, 5000),
				"THREAT_EVENTS":                       defaultISEGroupConfig(true, 5000),
				"USER_IDENTITY_GROUPS":                defaultISEGroupConfig(true, 5000),
			},
		},
	}
}
